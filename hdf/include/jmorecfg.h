...
/* This will only be defined if JPEG was built with CMake shared libs*/
#ifdef JPEG_BUILT_AS_DYNAMIC_LIB
...
#else /* JPEG_BUILT_AS_DYNAMIC_LIB */
/* This is the original defined preprocessor code */
/* a function referenced thru EXTERNs: */
#define GLOBAL(type)    type
/* a reference to a GLOBAL function: */
#define EXTERN(type)    extern type

#endif /* JPEG_BUILT_AS_DYNAMIC_LIB */
